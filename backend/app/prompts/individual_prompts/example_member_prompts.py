...
4. 테스트: GPTService("[본인이름]")로 사용
"""

from ..base_prompts import MenuAnalysisPrompt, MealPlanPrompt
from typing import Dict, Any

class MyMenuAnalysisPrompt(MenuAnalysisPrompt):
    """내가 실험하는 메뉴 분석 프롬프트"""
    
    def get_system_message(self) -> str:
        return """당신은 키토 다이어트 전문가입니다.
        
여기에 본인만의 시스템 메시지를 작성해보세요.
...
{{"keto_score": 점수, "menu_type": "main"또는"side"}}"""
    ...
    def get_model_config(self) -> Dict[str, Any]:
        return {
            ...
            "temperature": 0.1  # 본인이 원하는 값으로 조정
        }

class MyMealPlanPrompt(MealPlanPrompt):
    """내가 실험하는 식단 추천 프롬프트"""
...
"""
    ...
    def get_model_config(self) -> Dict[str, Any]:
        return {
            ...
            "temperature": 0.6  # 본인이 원하는 값으로 조정
        }

# 실험할 때 이 부분을 team_prompts.py에 추가하세요:
# TEAM_PROMPTS["내이름"] = {
#     "menu_analysis": MyMenuAnalysisPrompt(),
#     "meal_plan": MyMealPlanPrompt()
# }
